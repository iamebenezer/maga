...
(function(me, ve) {
    typeof exports == "object" && typeof module < "u" ? module.exports = ve() : typeof define == "function" && define.amd ? define("uikit", ve) : (me = typeof globalThis < "u" ? globalThis : me || self, me.bdtUIkit = ve())
})(this, function() {
    "use strict";
    const {
        hasOwnProperty: me,
    ...
    function p(t, e, i) {
        ...
        for (const n of C(t)) et(i) && (i = i.call(n, p(n, e))), i === null ? ye(n, e) : n.setAttribute(e, i)
    }
    ...
    function H(...t) {
        const [e, i, s, n, o = !1, r] = Ji(t), a = b(e, i, s, l => {
            const h = !r || r(l);
            h && (a(), n(l, h))
        }, o);
        return a
    ...
    function hr(t, e) {
        return i => {
            const s = t[0] === ">" ? Ee(t, i.currentTarget).reverse().find(n => n.contains(i.target)) : i.target.closest(t);
    ...
    function Ys(t, e, i = 200, s, n) {
        return Promise.all(C(t).map(o => new Promise((r, a) => {
            ...
            H(o, [Vs, ai], ({
                ...
                self: !0
            }), c(o, "animationDuration", `${i}ms`), $(o, e, Pe + (n ? "leave" : "enter")), dt(e, Pe) && (s && $(o, `bdt-transform-origin-${s}`), n && $(o, `${Pe}reverse`))
        })))
    }
    ...
    function _e(t) {
        C(t).map(P).filter((e, i, s) => s.indexOf(e) === i).forEach(e => e.replaceWith(...e.childNodes))
    }
    const br = /^<(\w+)\s*\/?>(?:<\/\1>)?$/;
    ...
    function w(t) {
        const e = xe(t) ? F(t).getBoundingClientRect() : {
            height: it(t),
            width: di(t),
            top: 0,
            left: 0
    ...
    function Ir() {
        return De || (re || (re = k("<div>"), c(re, {
            height: "100vh",
            position: "fixed"
        }), b(window, "resize", () => De = null)), L(document.body, re), De = re.clientHeight, at(re), De)
    }
    ...
    function hs(t) {
        ...
        return t.ownerDocument.elementsFromPoint(e + i / 2, s).find(n => !n.contains(t) && !y(n, "bdt-togglable-leave") && (cs(n, "fixed") && dn(Te(t).reverse().find(o => !o.contains(n) && !cs(o, "static"))) < dn(n) || cs(n, "sticky") && P(n).contains(t)))
    }
    ...
    const Y = {};
    Y.events = Y.watch = Y.observe = Y.created = Y.beforeConnect = Y.connected = Y.beforeDisconnect = Y.disconnected = Y.destroy = fs, Y.args = function(t, e) {
        return e !== !1 && fs(e || t)
    ...
    function Fe(t = {}) {
        return ze({
            handler: function(e, i) {
                ...
                for (const o of C(et(s) ? s(this) : s)) z('[loading="lazy"]', o).slice(0, n - 1).forEach(r => ye(r, "loading"));
    ...
    function Sn(t, e, i, s = 0) {
        const n = xi(e, !0),
            ...
            l = a(async () => {
                $(e, bs), await Promise.all(Tn(e).map((u, d) => new Promise(f => setTimeout(() => O.start(u, r, i / 2, "ease").then(f), d * s)))), D(e, bs)
            }),
            h = a(async () => {
                const u = it(e);
                $(e, xs), t(), c(B(e), {
    ...
    function Tn(t) {
        return vs(B(t)).flat().filter(e => q(e))
    }
    ...
    async function ha(t, e, {
        ...
        const [l = "reveal", h = "top"] = ((a = i[0]) == null ? void 0 : a.split("-")) || [], u = [
            ["left", "right"],
            ["top", "bottom"]
        ], d = u[m(u[0], h) ? 0 : 1], f = d[1] === h, x = ["width", "height"][u.indexOf(d)], T = `margin-${d[0]}`, M = `margin-${h}`;
        let wt = w(t)[x];
        ...
        f && (c(t, T, te - wt + ge), Ko[T] = e ? ge : te + ge), !f ^ l === "reveal" && (c(Ni, T, -te + wt), O.start(Ni, {
            [T]: e ? 0 : -te
        }, s, o));
        try {
    ...
    var wa = {
        ...
        methods: {
            start() {
                this.drag = this.pos, this._transitioner ? (this.percent = this._transitioner.percent(), this.drag += this._transitioner.getDistance() * this.percent * this.dir, this._transitioner.cancel(), this._transitioner.translate(this.percent), this.dragging = !0, this.stack = []) : this.prevIndex = this.index, b(document, Ss, this.move, Re), b(document, Nn, this.end, Bn), c(this.list, "userSelect", "none")
            },
            move(t) {
                ...
                setTimeout(() => Pt(this.list, "click", zn, Re)), c(this.list, {
                    userSelect: ""
    ...
    function $a(t, e) {
        for (const {
                ...
                handler: s,
                immediate: n = !0
            } of t._watches)(t._initial && n || pt(e, i) && !ei(e[i], t[i])) && s.call(t, t[i], e[i]);
        t._initial = !1
    }
    ...
    function Un(t) {
        ...
        for (const a in s) {
            const l = Mt(a);
            let h = X(n, l);
            G(h) || (h = s[a] === Boolean && h === "" ? !0 : ps(s[a], h), !(l === "target" && dt(h, "_")) && (e[a] = h))
        }
        const r = ce(X(n, o), i);
        for (const a in r) {
            const l = we(a);
    ...
    function Ts(t) {
        t._connected || (Aa(t), de(t, "beforeConnect"), t._connected = !0, Ta(t), qr(t), xa(t), Ea(t), Oa(t), ka(t), de(t, "connected"), Ne(t))
    }
    ...
    function Wa(t) {
        t.component = Yn, t.getComponents = Xt, t.getComponent = ki, t.update = Gn, t.use = function(i) {
    ...
    function Es(t, e, i) {
        return i.length === 1 && i.unshift(Ge(e, t, "")), i = pe(i, s => Ka(e, s)), (s, n) => {
    ...
    function Za(t, e, i) {
        return i.length === 1 && i.unshift(Ge(e, t, "")), i = pe(i), (s, n) => {
            s[t] = Ye(i, n)
        }
    }
    ...
    function ol(t, e, i, {
        ...
        return {
            ...
            show(h, u = 0, d) {
                const f = d ? "linear" : n;
                return h -= Math.round(h * tt(u, -1, 1)), this.translate(u), u = t ? u : tt(u, 0, 1), _s(this.getItemIn(), "itemin", {
                    percent: u,
                    duration: h,
                    timing: f,
                    dir: i
    ...
    function ll(t, e) {
        ...
        for (const o in s) {
            ...
            if (h > zt(s.filter(u => !l.has(u)), u => w(u).width)) return !0
        }
        return !1
    }
        ...
        dl = {
            ...
            methods: {
                init(t) {
                    ...
                    !n || s || i > 0 || Vi(e) || e.closest(`.${this.clsNoDrag}`) || this.handle && !e.closest(this.handle) || (t.preventDefault(), this.touched = new Set([this]), this.placeholder = n, this.origin = {
                        target: e,
                        index: Et(n),
                        ...this.pos
        ...
        methods: {
            ...
            async _show(t, e) {
                this.tooltip = L(this.container, `<div id="${e}" class="bdt-${this.$options.name}" role="tooltip"> <div class="bdt-${this.$options.name}-inner">${t}</div> </div>`), b(this.tooltip, "toggled", (i, s) => {
                    ...
                    const a = [H(document, `keydown ${mt}`, this.hide, !1, l => l.type === mt && !this.$el.contains(l.target) || l.type === "keydown" && l.keyCode === _.ESC), b([document, ...Vt(this.$el)], "scroll", n, {
                        passive: !0
                    })];
    ...
    function Pl(t) {
        qt && window.MutationObserver && (document.body ? requestAnimationFrame(() => Io(t)) : new MutationObserver((e, i) => {
    ...
    function Io(t) {
        g(document, "uikit:init", t), document.body && St(document.body, To), new MutationObserver(e => e.forEach(_l)).observe(document, {
            subtree: !0,
            childList: !0
    ...
    async function Ol(t, e, {
        ...
        s = (n * h + s) * (e ? 1 - u : u), c(a, "height", l), await O.start(a, {
            height: e ? h : 0
        }, s, o), _e(i), delete t._wrapper, e || Ai(i, !0)
    }
    ...
    var Do = {
        ...
        connected() {
            $(this.$el, "bdt-drop", this.clsDrop), this.toggle && !this.targetEl && (this.targetEl = Ll(this)), this._style = Li(this.$el.style, ["width", "height"])
        },
        disconnected() {
    ...
    function Oo(t, e = () => t.$emit()) {
        return b([document, ...Vt(t.$el)], "scroll", e, {
            passive: !0
        })
    }
        ...
        Vl = {
            ...
            update: [{
                ...
                read(t) {
                    ...
                    if (s = Math.max(0, U(s)), !(i || s || n) || No(e) || e[0].some((x, T) => e.some(M => M[T] && M[T].offsetWidth !== x.offsetWidth))) return t.translates = t.scrollColumns = !1;
                    let r = Gl(e, o),
                        a, l;
                    ...
                    const h = a.map(x => zt(x, "offsetHeight") + r * (x.length - 1)),
                        u = Math.max(0, ...h);
                    let d, f, v;
                    return (s || n) && (d = h.map((x, T) => n ? u - x + s : s / (T % 2 || 8)), n || (s = Math.max(...h.map((x, T) => x + d[T] - u))), f = U(this.parallaxStart, "height", this.$el, !0), v = U(this.parallaxEnd, "height", this.$el, !0)), {
                        columns: a,
                        translates: l,
                        scrollColumns: d,
                        parallaxStart: f,
    ...
    var Jl = {
        ...
        update: {
            read() {
                return {
                    rows: (this.row ? vs(this.elements) : [this.elements]).map(Kl)
                }
            },
            write({
                rows: t
    ...
    const Di = {
        ...
        kh = {
            ...
            beforeConnect() {
                ...
                if (this.icon = t ? "search-toggle-icon" : y(this.$el, "bdt-search-icon") && oi(this.$el, ".bdt-search-large") ? "search-large" : oi(this.$el, ".bdt-search-navbar") ? "search-navbar" : this.$props.icon, !yt(this.$el, "aria-label"))
                    if (t) {
    ...
    function Ah(t) {
        t.icon.add = (e, i) => {
            ...
            Nt(s, (n, o) => {
                Di[o] = n, delete Oi[o]
            }), t._initialized && St(document.body, n => Nt(t.getComponents(n), o => {
    ...
    var jh = {
        ...
        update: {
            read() {
                for (const t of this.target) si(t, "bdt-light,bdt-dark", !this.selActive || E(t, this.selActive) ? Rh(t) : "")
            }
        }
    };
    ...
    var Jh = {
        ...
        events: [{
            ...
            handler() {
                ...
                $(t, this.clsContainer, this.clsFlip), c(t, "touch-action", "pan-y pinch-zoom"), c(this.$el, "display", "block"), c(this.panel, "maxWidth", e.clientWidth), $(this.$el, this.clsOverlay), $(this.panel, this.clsSidebarAnimation, this.mode === "reveal" ? "" : this.clsMode), it(t), $(t, this.clsContainerAnimation), this.clsContainerAnimation && Kh()
            }
        }, {
            name: "hide",
            self: !0,
            ...
            self: !0,
            handler() {
                this.clsContainerAnimation && Zh(), this.mode === "reveal" && _e(this.panel), D(this.panel, this.clsSidebarAnimation, this.clsMode), D(this.$el, this.clsOverlay), c(this.$el, "display", ""), c(this.panel, "maxWidth", ""), D(document.body, this.clsContainer, this.clsFlip)
            }
        }, {
    ...
    function Ro(t) {
        if (!t.defaultPrevented)
            for (const e of Ke) e.$el.contains(t.target) && oe(e.$el) && (t.preventDefault(), window.location.href !== e.$el.href && window.history.pushState({}, "", e.$el.href), e.scrollTo(Yi(e.$el)))
    }
    var nc = {
            args: "cls",
            props: {
        ...
        rc = {
                ...
                handler() {
                    ...
                    !location.hash || t.scrollTop === 0 || setTimeout(() => {
                        const e = I(k(location.hash)),
                            i = I(this.$el);
                        this.isFixed && Wi(e, i) && (t.scrollTop = e.top - i.height - U(this.targetOffset, "height", this.placeholder) - U(this.offset, "height", this.placeholder))
                    })
                }
            }, {
            ...
            update: [{
                read({
                    ...
                    return s = a && !this.showOnUp && x + u === f && T === Math.min(a, Bs(!0, this.$el, 0, !0) - v - u + d) && c(P(this.$el), "overflowY") === "visible", {
                        start: x,
                        end: T,
                        offset: u,
                        overflow: d,
    ...
    var Go = {
            ...
            update() {
                ...
                for (const e in this.toggles) {
                    ...
                    p(i, "role", "tab"), s && (i.id = Jt(this, i), s.id = Jt(this, s), p(i, "aria-controls", s.id), p(s, {
                        role: "tabpanel",
                        "aria-labelledby": i.id
                    }))
                }
    ...
    var pc = {
            ...
            events: [{
                ...
                handler(t) {
                    this._preventClick = null, !(!kt(t) || se(this._showState) || this.$el.disabled) && (g(this.$el, "focus"), H(document, mt, () => g(this.$el, "blur"), !0, e => !this.$el.contains(e.target)), m(this.mode, "click") && (this._preventClick = !0))
                }
            }, {
